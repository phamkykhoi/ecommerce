{!! Html::script('admin/assets/js/skins.min.js') !!}
{!! Html::script('admin/assets/js/jquery.min.js') !!}
{!! Html::script('admin/assets/js/bootstrap.min.js') !!}
{!! Html::script('admin/assets/js/slimscroll/jquery.slimscroll.min.js') !!}
{!! Html::script('admin/assets/js/beyond.js') !!}
{!! Html::script('admin/assets/js/charts/sparkline/jquery.sparkline.js') !!}
{!! Html::script('admin/assets/js/charts/sparkline/sparkline-init.js') !!}
{!! Html::script('admin/assets/js/charts/easypiechart/jquery.easypiechart.js') !!}
{!! Html::script('admin/assets/js/charts/easypiechart/easypiechart-init.js') !!}
{!! Html::script('admin/assets/js/charts/flot/jquery.flot.js') !!}
{!! Html::script('admin/assets/js/charts/flot/jquery.flot.resize.js') !!}
{!! Html::script('admin/assets/js/charts/flot/jquery.flot.pie.js') !!}
{!! Html::script('admin/assets/js/charts/flot/jquery.flot.tooltip.js') !!}
{!! Html::script('admin/assets/js/charts/flot/jquery.flot.orderBars.js') !!}
